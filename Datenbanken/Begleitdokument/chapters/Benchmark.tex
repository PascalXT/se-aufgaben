...
Da Q7 über 62 Millionen Tupel aggregieren muss, wurden für den Benchmark aus Lauf\-zeit\-grün\-den nur die Stimmen der Wahlkreise 213 - 217 in die
Datenbank geladen. 
...
\section{Messverfahren und Ziele}
 ...
 Alle Queries benutzen für die Berechnung von Zwischenergebnissen temporäre Tabellen. In DB2 gibt es dafür im Wesentlichen zwei Ansätze:
...
Beim Durchschauen der Benchmark-Ergebnisse fällt auf, dass die erste Anfrage oft um Größenordnungen länger für die Ausführung braucht, 
...
\texttt{GOBAL TEMPORARY} tables ist dem\-ent\-sprech\-end vermutlich ebenfalls auf andere Caching Eigenschaften zurückzuführen. 
In einer realen Implementierung sollte der Entwickler das Caching selber übernehmen und bei jeder Brow\-ser Anfrage nur die minimal 
