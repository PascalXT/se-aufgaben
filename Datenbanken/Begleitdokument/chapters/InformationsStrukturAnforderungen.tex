...
\textbf{Beziehungsbeschreibung}: wählt (1. Stimme)
\begin{itemize}
	\item Beteiligte Objekte
		\begin{itemize}
			\item Stimme als Wähler
			\item Kandidat als Empfänger der Stimme
		\end{itemize}
	\item Anzahl: 45.000.000
\end{itemize}

\textbf{Beziehungsbeschreibung}: wählt (2. Stimme)
\begin{itemize}
	\item Beteiligte Objekte
		\begin{itemize}
			\item Stimme als Wähler
			\item Partei als Empfänger der Stimme
		\end{itemize}
	\item Anzahl: 45.000.000
\end{itemize}