...
public class FlagDefinition {
	...
	final public static String[][] kFlagDefinition = { 
		...
		{ kFlagParserErststimmenFile, null, "Path of the file used for storing the single votes created in the " + "parser. This file will be loaded by a db2 import." }, 
		{ kFlagParserZweitstimmenFile, null, "Path of the file used for storing the single votes created in the " + "parser. This file will be loaded by a db2 import." }, 
		...
		{ kFlagCreateTables, Flags.kTrue, "If true, the database tables will be created in the beginning." }, 
		{ kImportCsvFiles, Flags.kFalse, "If true, the csv files will be imported in the beginning." }, 
		{ kFlagCreateVotes, Flags.kTrue, "If true, the csv files containing the votes will be generated." }, 
